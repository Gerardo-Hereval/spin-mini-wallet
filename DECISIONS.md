...
- **Persistencia de contacto nuevo solo si la transacción tiene éxito**: un contacto nuevo ingresado en el wizard no se guarda hasta que la transacción se valida y se completa correctamente; guardarlo antes dejaría contactos "huérfanos" de transacciones fallidas.
